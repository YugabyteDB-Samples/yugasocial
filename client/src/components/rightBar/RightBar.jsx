...
const RightBar = () => {
  ...
  const { isLoading: relationshipsIsLoading, data: relationshipData } =
    useQuery(["relationshipSidebar"], () =>
      makeRequest
    ...
    <div className="rightBar">
      <div className="container">
        <div className="item">
          ...
          {usersLoading || relationshipsIsLoading
            ? "Loading..."
            : users?.map((user) => {
                const profPic =
                ...
                return (
                  <div className="user" key={user.id}>
                    ...
                    <div className="buttons">
                      ...
                      <button
                        className="dismiss"
                        onClick={(e) => filterUsersOnClient(e, user.id)}
                      >
                        Dismiss
                      </button>
                    </div>
